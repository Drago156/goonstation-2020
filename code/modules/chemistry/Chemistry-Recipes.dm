...
/*
		medusa_real
			...
			id = "medusa"
			result = "medusa"
			required_reagents = list("oculine" = 1, "juice_carrot" = 1)
			result_amount = 2
			mix_phrase = "The solution fizzes and begins losing color."
			mix_sound = 'sound/misc/drinkfizz.ogg'
*/
		medusa_charcoal
			...
			id = "medusa"
			result = "medusa"
			required_reagents = list("medusa" = 1, "charcoal" = 1)
			result_amount = 2
			mix_phrase = "The green substance absorbs the charcoal and doubles it's own mass."
			mix_sound = 'sound/misc/drinkfizz.ogg'
		...
		medusa_calomel
			...
			id = "medusa"
			result = "medusa"
			required_reagents = list("medusa" = 1, "calomel" = 1)
			result_amount = 2
			mix_phrase = "The green substance absorbs the calomel and doubles it's own mass."
			mix_sound = 'sound/misc/drinkfizz.ogg'
